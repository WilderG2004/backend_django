...
SECRET_KEY = 'django-insecure-*8uxlf#c7lat-o33if%d2_qh0-_w0b++ic)(n=7#t4_js&@085'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'emergencias_db',   # Cambia por el nombre exacto de tu base
        'USER': 'postgres',         # O el usuario que usas
        'PASSWORD': '12345678',    # Cambia por tu password
